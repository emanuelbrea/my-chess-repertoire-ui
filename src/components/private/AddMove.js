...
import {Card, CardActionArea, CardMedia, Container, IconButton, Skeleton} from '@mui/material';
import Alert, {getSvgUrl} from '../public/Util.js';
                    ...
                    >
                      ...
                      <DialogContent>
                        <Grid container spacing={5} justifyContent={'center'} paddingRight={2} paddingLeft={2}>
                          {moves.filter(function(myMove) {
                            return (myMove.move !== move.move);
                          }).map((move, index) => (
